...
//   }
  ...
  if (Serial.available() > 0) {
      ...
      String stationnement = Serial.readString(); // ASCII values that are being used in the subtraction
      ok =true;

       
      distance = distanceCalcul();  
      lcd.setCursor(2,0);
      lcd.print("Total Entries");
      lcd.setCursor(7,1);
     
     lcd.print(stationnement);

      if (stationnement == "accepte") {
